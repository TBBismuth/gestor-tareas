  ...
  plugins: [react(), tailwindcss(), VitePWA({
    ...
    manifest: {
      ...
      screenshots: [
        ...
        {
          src: '/screenshots/desktop-tasks.png',
          sizes: '1920x1080',
          type: 'image/png',
          form_factor: 'wide',
          label: 'Tareas — escritorio'
        }],
      shortcuts: [
        {
          name: 'Mis tareas',
          short_name: 'Tareas',
          description: 'Abrir la lista de tareas',
          url: '/home',
        ...
        },
        {
          name: 'Nueva tarea',
          short_name: 'Nueva',
          description: 'Ir a la pantalla de tareas para crear una nueva',
          url: '/home?newTask=1', // (más adelante podemos hacer que este query abra el modal)
          icons: [{ src: '/icons/pwa-192.png', sizes: '192x192', type: 'image/png' }]
        }
      ],
